...
@description('Specifies the name of the App Configuration instance.')
param appConfigurationName string = 'config-${uniqueString(resourceGroup().id)}'

@description('Specifies the name of the User-Assigned Managed Identity.')
param userAssignedManagedIdentityName string = 'user-assigned-mi-${uniqueString(resourceGroup().id)}'
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  name: guid(containerApp.id, appConfiguration.id, 'App Configuration Data Reader')
